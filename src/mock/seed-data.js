...
export const systems = [
  { id: 'sys-weapon', name: '综合武器管理系统', desc: '覆盖武器挂载、状态监测与装控指令报文的联试对象', owner: '装备联试组' },
  { id: 'sys-fire',   name: '火控指挥联试系统', desc: '覆盖目标分配、火控解算与指挥链路报文的联试对象', owner: '火控联试组' },
]
 ...
 *  全部为可客观度量的字段，不含联试对象内部资源等无法获取的指标。
 * ──────────────────────────────────────────── */
