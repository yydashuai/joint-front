...
const tasks = [
  { id: 't1', name: '武器状态接口连通性测试', systemId: 'sys-weapon', moduleId: 101, status: '执行中', time: '2026-06-24 10:31:00', remark: '验证 WM-001 接口在标准帧格式下的握手与应答流程' },
  { id: 't2', name: '弹药余量边界值检测', systemId: 'sys-weapon', moduleId: 102, status: '已完成', time: '2026-06-24 09:45:00', remark: '覆盖 0%/100% 边界值，已生成测试报告' },
  { id: 't3', name: '武器挂载自检流程验证', systemId: 'sys-weapon', moduleId: 101, status: '已完成', time: '2026-06-24 09:10:00', remark: '' },
  { id: 't4', name: '火控解算异常回放', systemId: 'sys-fire-control', moduleId: 103, status: '异常', time: '2026-06-24 09:20:00', remark: '回放 08:55 采集的异常帧数据，解算结果偏差超限' },
  { id: 't5', name: '指挥链路报告生成任务', systemId: 'sys-fire-control', moduleId: 104, status: '待确认', time: '2026-06-24 08:50:00', remark: '链路当前不通，待恢复后自动执行' },
  { id: 't6', name: '目标分配协议一致性检测', systemId: 'sys-fire-control', moduleId: 103, status: '执行中', time: '2026-06-24 10:15:00', remark: '对比协议 v2.1 与 v2.2 的字段差异' }
]

/* ========== Mock 数据：异常告警（含 moduleId + remark） ========== */
const alerts = [
  { id: 'a1', type: '字段越界', iface: 'WM-003', level: '高', state: '已修复', systemId: 'sys-weapon', moduleId: 101, resolvedTime: '2026-06-24 10:05:00', remark: '温度字段值 256 超出 uint8 范围，已修正传感器标定参数' },
  { id: 'a2', type: '响应超时', iface: 'FC-017', level: '中', state: '已记录', systemId: 'sys-fire-control', moduleId: 103, resolvedTime: '', remark: '连续 3 次超时 > 500ms，链路不稳定暂无法处理' },
  { id: 'a3', type: '格式错误', iface: 'WM-006', level: '高', state: '已转派', systemId: 'sys-weapon', moduleId: 102, resolvedTime: '2026-06-24 09:58:00', remark: '帧头校验码不匹配，已转派固件组排查版本一致性' },
  { id: 'a4', type: '心跳丢失', iface: '指挥链路模块', level: '中', state: '自动恢复', systemId: 'sys-fire-control', moduleId: 104, resolvedTime: '2026-06-24 08:47:00', remark: '心跳自动恢复，根因待排查' },
  { id: 'a5', type: '帧头校验失败', iface: 'FC-021', level: '高', state: '待处理', systemId: 'sys-fire-control', moduleId: 103, resolvedTime: '', remark: '' },
  { id: 'a6', type: '数据帧丢失', iface: 'FC-025', level: '中', state: '已处理', systemId: 'sys-fire-control', moduleId: 103, resolvedTime: '2026-06-24 10:22:00', remark: '重传机制触发后恢复正常' }
]
