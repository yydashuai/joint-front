  ...
  <div class="strategy-stack">
    <el-card shadow="never" class="exec-card strategy-card">
      ...
      <el-form label-width="96px" :model="config" class="strategy-form">
        <el-form-item label="执行模式" class="mode-form-item">
    ...
    <el-card shadow="never" class="exec-card strategy-card">
      <template #header>
        <div class="card-head">
          <span class="card-title">何时开始</span>
        </div>
      </template>

      <el-form label-width="96px" :model="config" class="strategy-form">
        <el-form-item label="触发方式" class="trigger-form-item">
          <div class="segmented-field">
...
.strategy-stack { display: flex; flex-direction: column; gap: 14px; }
...
.mode-form-item, .trigger-form-item { margin-top: 14px; }
